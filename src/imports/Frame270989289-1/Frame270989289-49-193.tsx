...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[664px] items-start relative shrink-0 w-[684px]">
      <Frame5 />
      <Frame2 />
    </div>
  );
...
function Container2() {
  return (
    <div className="h-[664px] relative rounded-[28px] shrink-0 w-[684px]" data-name="Container">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[28px]">
